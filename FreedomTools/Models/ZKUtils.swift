...
class ZKUtils {
    ...
    static public func calcWtnsAuthV2(inputsJson: Data) throws -> Data {
        let dat = NSDataAsset(name: "authV2.dat")!.data
        return try _calcWtnsAuthV2(dat: dat, jsonData: inputsJson)
    }
    
    static private func _calcWtnsAuthV2(dat: Data, jsonData: Data) throws -> Data {
#if targetEnvironment(simulator)
        return Data()
#else
        let datSize = UInt(dat.count)
    ...
    static public func calcWtnscredentialAtomicQueryMTPV2OnChainVoting(inputsJson: Data) throws -> Data {
        let dat = NSDataAsset(name: "credentialAtomicQueryMTPV2OnChainVoting.dat")!.data
        return try _calcWtnscredentialAtomicQueryMTPV2OnChainVoting(dat: dat, jsonData: inputsJson)
    }
    
    static private func _calcWtnscredentialAtomicQueryMTPV2OnChainVoting(dat: Data, jsonData: Data) throws -> Data {
#if targetEnvironment(simulator)
        return Data()
#else
        let datSize = UInt(dat.count)
    ...
    static public func calcWtnsvoteSMT(inputsJson: Data) throws -> Data {
        let dat = NSDataAsset(name: "voteSMT.dat")!.data
        return try _calcWtnsvoteSMT(dat: dat, jsonData: inputsJson)
    }
    
    static private func _calcWtnsvoteSMT(dat: Data, jsonData: Data) throws -> Data {
#if targetEnvironment(simulator)
        return Data()
#else
        let datSize = UInt(dat.count)
    ...
    static public func groth16credentialAtomicQueryMTPV2OnChainVoting(wtns: Data) throws -> (proof: Data, publicInputs: Data) {
        return try _groth16Prover(zkey: NSDataAsset(name: "credentialAtomicQueryMTPV2OnChainVoting.zkey")!.data, wtns: wtns)
    }
    
    static public func groth16voteSMT(wtns: Data) throws -> (proof: Data, publicInputs: Data) {
        return try _groth16Prover(zkey: NSDataAsset(name: "voteSMT.zkey")!.data, wtns: wtns)
    }
